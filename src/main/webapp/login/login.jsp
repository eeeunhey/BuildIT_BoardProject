...
<body>
  <div class="container">
    ...
    <div class="left-section">
      <p class="slogan">빌드잇에서 서비스를<br>하나의 계정으로!</p>
      <img src="${pageContext.request.contextPath}/resources/images/logo.png" alt="서비스 이미지" class="login-image">
    </div>
    ...
    <div class="login-box">
      ...
      <form action="${pageContext.request.contextPath}/login/loginProcess.do" method="post">
        ...
        <input type="text" name="id" placeholder="아이디 또는 이메일" class="input-field" required>
